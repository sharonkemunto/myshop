...
?>
  ...
  <form action="" method="post" enctype="multipart/form-data">
            ...
            <table align="center" width="750">
                ...
                <td><input type="file" name="c_image"/><img src="customer_images/<?php echo $c_image;?>"
                width="50" height="50"/>
...
<?php
    if(isset($_POST['update']))
    {
        ...
        //we dont need country since we disabled in in updates
        $c_city=$_POST['c_city'];
  ...
  $update_c="update customers set customer_name='$c_name',customer_email='$c_email',customer_pass='$pass',customer_city='$c_city',

...
<div id="sidebar_title">Brands</div>  
    ...
    <?php cart();?>
     ...
     <span style="float:right; font-size:18px; padding:5px; line-height:40px;">
        Welcome!Find Everything Near You!<b style="color:yellow"> shopping_cart-</b> Total items:<?php total_items();?> Total Price:<?php total_price();?><a href="cart.php" style="color:yellow">Go to Cart</a>
     </span>
     </div>
  ...
  <form action="customer_register.php" method="post" enctype="multipart/form-data">
            <table align="center" width="750">
                ...
                <td><input type="file" name="c_image"required/></td>   //customer can upload image
                </tr>
...
<?php
    ...
    {
        $ip=getIp(); //getting ip and storing it in a local variable

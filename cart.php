...
echo "<b>Welcome</b>"  . $_SESSION['customer_email'] . "<b style='color:yellow;'>Your</b>";
    ...
    echo "<b>Welcome Guest</b>";
     ...
     ?>
        <b style="color:yellow"> shopping_cart-</b> Total items:<?php total_items();?> Total Price:<?php total_price();?><a href="index.php" style="color:yellow">Back To Shop</a>
    ...
    <form action="" method="post"enctype="multipart/form-data">
            <table align="center" width="700" bgcolor="skyblue">
                ...
                <tr align="center">
                        ...
                        <img src="Admin-area/product_images/<?php echo $product_image;?>" width="60" height="60"/>
                        </td>
                        ...
                        if(isset($_POST['update_cart']))
                        {
                            ...
                            //changing total variable possible in php
            ...
            <tr align="right"> 
                    ...
                    <td colspan="5"><?php echo"ksh".$total; ?></td>
                </tr>
            <tr align="center"> 
            <td colspan="2"><input type="submit" name="update_cart" value ="update cart"/></td>
            <td><input type="submit" name="continue" value ="Continue Shopping"/></td>
            <td><a href="checkout.php"style="text-decoration:none; color:black;"><button>Checkout</a></button></a></td>
            </tr>
            </table>
    </form>
<?php 
